...
let
  ...
  genAddr = num: {
    ...
    hostAddress6 =
      "2a01:e34:ec48:3616::1:${lib.trivial.toHexString (num * 2 + 1)}";
    localAddress6 =
      "2a01:e34:ec48:3616::1:${lib.trivial.toHexString (num * 2 + 2)}";
  };
  peer = num: publicKey: {
    inherit publicKey;
    allowedIPs = [
      "10.42.6.${builtins.toString num}/32"
      "2a01:e34:ec48:3616::2:${lib.trivial.toHexString num}/128"
    ];
  };
...
in {
  ...
  networking.wireguard = {
    ...
    interfaces.wg0 = {
      ...
      listenPort = 51820;
      allowedIPsAsRoutes =
        false; # Let's rely on iface IPs instead of peers allowedIPs
      peers = [
        (peer 1
          "Cb665kMFY7Im8bj4bgnn/TUWVWA6s4FfKnJOAUHm1Wc=") # sandhose-laptop
      ];
    };
  };
}
